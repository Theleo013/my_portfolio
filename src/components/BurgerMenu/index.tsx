...
const Menu: React.FC<{ open: boolean }> = ({ open }) => {
  ...
  return (
    <nav
      ...
      className={`flex justify-center items-center absolute inset-x-0 top-18 w-screen h-[18rem] bg-[rgba(29,26,25,0.95)] rounded-md shadow-lg overflow-hidden transform 
